      ...
      <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
        ...
        <div style={card}>
          ...
          {signals.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, height: 440, overflowY: 'scroll', padding: 10, background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 12 }}>
              {signals.map(s => (
